...
public class FunctionalInterfaces {
    ...
    private static void runPredicateExample2() {
        Predicate<Integer> isEven = number -> number % 2 == 0;
        Predicate<Integer> isAdult = age -> age >= 18;

        System.out.println();
        System.out.println("Predicate:");
        System.out.println("4 is even? " + isEven.or(isAdult).test(4));
    ...
    private static void runFunctionExample2() {
        Function<String, Number> textLength = text -> text.length();

        System.out.println();
        System.out.println("Function:");
        System.out.println("java length -> " + textLength.apply("java"));
    }
